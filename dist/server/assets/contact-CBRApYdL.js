...
function ContactPage() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(PageShell, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHero, { eyebrow: "Get in Touch", title: "Contact", subtitle: "Questions, media inquiries, or recruiting interest — we want to hear from you." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto grid max-w-7xl gap-12 px-4 sm:px-6 lg:grid-cols-3", children: [{
      ...
      Icon: Mail,
      t: "Email",
      v: "info@reignathletics.com\nrecruiting@reignathletics.com"
    }].map(({
      Icon,
      t,
      v
    }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-l-2 border-primary bg-card/30 p-8", children: [
