...
const appCss = "/assets/styles-DSKw14Wj.css";
...
const Route$8 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Reign Athletics develops elite student-athletes through a championship basketball program built on discipline, competition, and excellence."
      }
    ],
    links: [
...
const $$splitComponentImporter$7 = () => import("./team-jWsDgStE.js");
const Route$7 = createFileRoute("/team")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Roster — Reign Athletics"
    }, {
...
const $$splitComponentImporter$6 = () => import("./stats-c_aQxReY.js");
const Route$6 = createFileRoute("/stats")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Individual and team statistics for the 2025-26 Reign Athletics season."
    }, {
      property: "og:title",
      content: "Stats — Reign Athletics"
    }, {
      property: "og:description",
...
const $$splitComponentImporter$5 = () => import("./schedule-C2W3IMun.js");
const Route$5 = createFileRoute("/schedule")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Academy Schedule — Reign Athletics"
    }, {
      property: "og:description",
      content: "Upcoming and completed Reign Basketball academy sessions."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./recruits-BgA70A5L.js");
const Route$4 = createFileRoute("/recruits")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Recruiting — Reign Athletics"
    }, {
      property: "og:description",
      content: "Join the program. Build your future."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./contact-CBRApYdL.js");
const Route$3 = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Get in touch with Reign Athletics. Visit our facility, call, or send us a message."
    }, {
      property: "og:title",
      content: "Contact — Reign Athletics"
    }, {
      property: "og:description",
      content: "Reach the program directly."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./coaches-DffD1qr4.js");
const Route$2 = createFileRoute("/coaches")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Meet the coaches leading the Reign Athletics basketball program."
    }, {
      property: "og:title",
      content: "Coaching Staff — Reign Athletics"
    }, {
      property: "og:description",
      content: "Meet the coaches behind the Reign."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./admin-No1Z0nSN.js");
...
const $$splitComponentImporter = () => import("./index-BqwEGv-t.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Youth development hub for Reign Athletics — academy sessions, coaching, and the future feeder program."
    }, {
      property: "og:title",
      content: "Reign Basketball Academy"
    }, {
      property: "og:description",
